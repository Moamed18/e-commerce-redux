...
import { getProductsByBrand } from '../../redux/Slices/ProductSlice'
...
export default function ProductByBrands(props) {
 ...
 let { productBrandList, loading } = useSelector((state) => state.productReduser)
  ...
  useEffect(() => {
    ...
    dispatsh(getProductsByBrand(id))
  }, [])
